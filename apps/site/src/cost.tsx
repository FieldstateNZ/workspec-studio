...
const PACKAGES: readonly CostPackage[] = [
  ...
  },
  {
    ...
    blurb: 'The pluggable cost-data provider contract, vendor-neutral result types, and an in-memory test double.',
  },
  {
    name: '@workspec/cost-provider-azure',
    source: `${REPO_URL}/cost-provider-azure`,
    blurb: 'Azure implementation — Resource Graph inventory, Cost Management spend, ARM tag apply and drift verification.',
  },
  {
    name: '@workspec/cost-engine',
    source: `${REPO_URL}/cost-engine`,
    blurb: 'Pure, normative attribution engine — matching, resolution, effects, overrides, coverage, rollups.',
  },
  {
    name: '@workspec/cost-ui',
    source: `${REPO_URL}/cost-ui`,
    blurb: 'Host-agnostic React views — the unified Attribution Workbench, Inventory, Reports, and Plan review.',
  },
  {
    name: '@workspec/cost-studio',
    source: `${REPO_URL}/cost-studio`,
    blurb: 'The CLI (workspec-cost: stocktake, validate, report, plan, apply) and localhost host shell.',
  },
];
        ...
        <main>
          <section className="hero">
            ...
            <p className="lede">
              ...
              every resource's spend against dimensions you declare (product, team, cost type, client
              — whatever your organisation actually reports on), and computes the tagging diff that
              converges live cloud tags on that result — straight from artifacts that live in your
              repo and version with git, no database, ever.
            </p>
          ...
          <section className="closing">
            <h2>See it move</h2>
            <p>
              A live Attribution Workbench running entirely in your browser against a worked
              example estate — no install, no signup, fully editable.{' '}
              <code>npx @workspec/cost-studio stocktake --subscription &lt;id&gt;</code> gives you
              the same workbench over your own subscription's real inventory and spend.
            </p>
            <Button asChild>
