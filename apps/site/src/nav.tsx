// Shared shell for the focused Cost Copilot site. The canonical WorkSpec
// thread mark comes from the main WorkSpec app; retired Studio modules remain
// in source for now, but are intentionally absent from public navigation.
  ...
  return (
    <header className="nav-bar">
      <div className="nav-inner">
        <Link href="/cost" className="brand" aria-label="WorkSpec Cost">
          ...
          <span className="brand-sub">/ cost</span>
        </Link>
