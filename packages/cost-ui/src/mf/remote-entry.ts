...
// wants a root input, so this file is it: intentionally empty. Mirrors
// packages/decision-ui/src/mf/remote-entry.ts and packages/c4-ui/src/mf/remote-entry.ts.
export {};
