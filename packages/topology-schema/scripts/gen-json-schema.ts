...
//
//   pnpm --filter @workspec/topology-schema gen:schema   (or: pnpm gen:schema)
//
// Writes `json-schema/topology.schema.json`, `json-schema/resource.schema.json`,
// `json-schema/environment.schema.json`, and `json-schema/topology-layout.schema.json`
...
// scripts/ → topology-schema/ → packages/ → <repo root>/json-schema/
