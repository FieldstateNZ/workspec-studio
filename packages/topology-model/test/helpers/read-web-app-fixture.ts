 ...
 * directory for that package's own schema-validation tests) and remaps
 * every file to its real `.workspec/<type-dir>/<slug>.yaml` path — the shape
 * this package's discovery/loading pipeline actually expects. Returns a
 * {@link MemorySourceSeed} ready for `createMemorySource`.
 */
