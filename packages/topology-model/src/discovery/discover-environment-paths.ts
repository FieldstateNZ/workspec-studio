...
/** Enumerates `.workspec/environments/*.yaml`. */
export async function discoverEnvironmentPaths(
  source: TopologyFileSource,
): Promise<readonly string[]> {
  return listYamlFiles(source, `${WORKSPEC_DIR}/${TYPE_DIRECTORIES.Environment}`);
}
