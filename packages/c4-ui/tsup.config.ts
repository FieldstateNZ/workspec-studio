...
// the bespoke canvas/tooltip/tree-nav styles), because the stylesheet
// requires a Tailwind compile. React is the host's — externalised so a
...
// @workspec/c4-schema / c4-model / c4-layout / design stay regular
...
// same `dist/`. Mirrors packages/decision-ui/tsup.config.ts exactly.
