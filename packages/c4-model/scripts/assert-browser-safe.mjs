...
// output is an external — and the only legitimate external for the root
// entry is @workspec/c4-schema. Complements the static source-graph test in
// test/browser-safety.test.ts by checking the artifact that actually ships.
